...
Prints information about the allocator. This information is cut off due to the
console limiting line length to 80 characters.
...
View console commands registered by the app.
